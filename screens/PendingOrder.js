...
const PendingOrder = () => {
  return (
    ...
    <View style={styles.container}>
      <Text style={styles.bordering}>Your pending Order</Text>

      
     
    
     < View style={[styles.box,styles.container]}>
     <Image  source={require("../assets/book-icon.webp")} style={styles.stretch}></Image>
     
<Text style={{ textAlign:"center"}}>Your boom Title here</Text>
<Text style={{ textAlign:"center"}}>PKR 567</Text>
